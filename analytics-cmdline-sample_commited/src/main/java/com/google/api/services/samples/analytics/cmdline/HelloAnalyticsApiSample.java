...
public class HelloAnalyticsApiSample {
   ...
   */
  private static final String APPLICATION_NAME = "VisionCloud";
  ...
  private static Credential authorize() throws Exception {
    ...
    GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(httpTransport, JSON_FACTORY, clientSecrets,Collections.singleton(AnalyticsScopes.ANALYTICS_READONLY)).setDataStoreFactory(dataStoreFactory).build();
    // authorize
