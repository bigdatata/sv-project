...
public class McfReportingApiReferenceSample {
   ...
   */
  private static final String APPLICATION_NAME = "visioncloud-weblog/1.0";
   ...
   */
  private static final String TABLE_ID = "AFB3siYqOO-PFptcoALI1A1SYeV6NqfoVkV_tUaRL0i-khaFRb037NeDQIWboo4DBXxlocbw4ZyFTuPg4nCmaljUqDOMDOamRw";
